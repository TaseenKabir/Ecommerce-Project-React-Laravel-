...
const Footer = () => {
    return (
        <footer className='py-5 text-white'>
            <div className='container'>
                <div className='row mb-5'>
                    <div className='col-md-3 pb-4'>
                        ...
                        <div className='pt-3 pb-3'>We choose the best syle for you</div>
                    </div>
                    <div className='col-md-3 pb-4'>
                    ...
                    <div className='col-md-3 pb-4'>
                        ...
                        <ul>
                            <li className='pb-3'>
                                <a href="tel:01916816152">+8801916-816152</a>
                            </li>
                            <li>
                ...
                <div className='row spotlight py-5'>
                    <div className='col-md-4 pb-4'>
                        <div className='d-flex justify-content-center'>
                            ...
                            <h3 className='ps-3'>Free Delivery over 1000/-</h3>
                        </div>
                    </div>
                    <div className='col-md-4 pb-4'>
                        <div className='d-flex justify-content-center'>
                            ...
                            <h3 className='ps-3'>Moneyback Guarantee</h3>
                        </div>
                    </div>
                    <div className='col-md-4 pb-4'>
                        <div className='d-flex justify-content-center'>
            ...
            <div className='row'>
                <div className='col-mod-12 text-center pt-5'>
                    <p>&copy; 2025 All Rights Reserved @Labelle.</p>
                </div>
            </div>
        </footer>
    )
